    ...
    render() {
        ...
        formFields = (
            <>
                ...
                <input className="form-control" type="text" name="firstName" id="firstName" placeholder="John" value={firstName} onChange={this.handleChange} />
                <label htmlFor="lastName">Last Name</label>
                <input className="form-control" type="text" name="lastName" id="lastName" placeholder="Appleseed" value={lastName} onChange={this.handleChange} />
            ...
            <div className="row">
                    ...
                    <div className="card col-8" style={{ marginTop: '5vh', boxShadow: 'rgb(136, 136, 136) 0px 2px 4px', borderRadius: '2%', height: '80%' }}>
                        ...
                        <div className="card-body">
                            ...
                            <form className="signin" onSubmit={this.handleSubmit}>
                                ...
                                <button className="btn btn-lg btn-square dark pull-right" style={{ marginTop: '35px' }} type="submit">
                ...
                <div className="col-6 sign-in-right" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <div style={{ marginTop: '30px', paddingLeft: '40px', paddingRight: '40px' }}>
                        ...
                        <button onClick={this.handleSwitch} name={this.props.switchButtonName} className="btn btn-lg btn-square clear" style={{ marginTop: '40px' }}>
                            {this.props.switchButtonText}
                        </button>
                    </div>
                </div>
            </div>
