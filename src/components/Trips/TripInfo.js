        ...
        return (
            <div class="card" style={{border: 'none', backgroundColor: '#FBFBFB'}}>
                ...
                <ul class="list-group list-group-flush" style={{backgroundColor: '#FBFBFB'}}>
                    ...
                    <li class="list-group-item" style={{backgroundColor: '#FBFBFB'}}>Status <span className='pull-right badge badge-primary badge-pill' style={{padding: '5px 10px', backgroundColor: '#8ECFF5'}}>PLANNING</span></li>
                    <li class="list-group-item" style={{backgroundColor: '#FBFBFB'}}>Total Invited <span className='pull-right badge badge-primary badge-pill' style={{padding: '5px 10px', backgroundColor: '#0F61D8'}}>215</span></li>
                    <li class="list-group-item" style={{backgroundColor: '#FBFBFB'}}>Total Confirmed <span className='pull-right badge badge-primary badge-pill' style={{padding: '5px 10px', backgroundColor: '#0F61D8'}}>85</span></li>
                </ul>
                <div class="card-body">
