                ...
                {this.state.hasVerifiedConnectAccount &&
                    <>
                        <Typography variant="subtitle2">{!this.state.hasConnectAccount ?
                            'Your organization\'s payments account is not yet verified. Please verify your account to request payments from travelers. After completing the form you will be redirected back to this page.'
