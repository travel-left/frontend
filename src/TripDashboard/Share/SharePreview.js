...
export default class SharePreview extends Component {
    ...
    sendTripToTravelers = () => {
        ...
        apiCall('post', '/api/communicate/text', {
            body: `Here\'s a link to your trip! https://app.travel-left.com/trips/${this.tripId}/share`,
            ...
            <div className="container">
                <div className="row mb-4 ml-2 mt-4 pr-5">
                    <div className="col-6">
                        ...
                        <button className="btn btn-lg btn-primary" onClick={this.sendTripToTravelers}>Send to travelers</button>
                    </div>
                    <div className="col-4">
