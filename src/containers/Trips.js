                ...
                <div className="col-10">
                    ...
                    <div className="row">
                        ...
                        <div className="col-4" style={{backgroundColor: '#FBFBFB', height: '100vh', boxShadow: 'rgb(136, 136, 136) 0px 2px 4px'}}>
                            <TripInfo id={selectedTrip._id} image={selectedTrip.image} description={selectedTrip.description} name={selectedTrip.name} date={selectedTrip.dateStart} edit={this.selectTrip}/>
                        </div>
                    </div>
                </div>
            </div>
